...
<section>
	<h1 class="font-sans text-4xl p-6 text-center">Searched</h1>
	...
	>
		<div class="grid xs:grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 bg-gray-50 ">
				...
				<div class="max-w-sm rounded overflow-hidden shadow-lg bg-white">
					...
					<div class="px-6 py-4">
						...
						<p class="text-gray-700 text-base">
							...
							<small
								>Release date:<span class=" p-1 text-gray-400">{movie.release_date}</span>
							</small>
						</p>
					</div>
				</div>
